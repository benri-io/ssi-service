...
func Artifact() error {
	...
	return sh.Run(Go, "build", "-tags", "jwx_es256k", "-o", "./bin/ssi-service", "./cmd/server")
}
...
func Spec() error {
	...
	return sh.Run(swagCommand, "init", "-g", "cmd/server/main.go", "--pd", "-o", "doc", "-ot", "yaml", "--parseDepth=3", "--parseGoList=false")
}
